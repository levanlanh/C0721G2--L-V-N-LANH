...
<table border="1">
  ...
  <c:forEach var="productObj" items="${productList}" >
    <tr>
      ...
      <td><a href="/product?action=edit&productId=${productObj.getProductId()}">edit</a></td>
      <td><a href="/product?action=delete&productId=${productObj.getProductId()}">delete</a></td>
    </tr>
  </c:forEach>
</table>
</body>
