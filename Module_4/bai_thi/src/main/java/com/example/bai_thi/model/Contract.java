...
public class Contract implements Validator {
    ...
    @Min(value = 1,message = "quantity khong nho 0")
    @Max(value = 100,message = "quantity khong qua 100")
    ...
    public void validate(Object target, Errors errors) {
        ...
        com.codegym.management.model.Contract contract = (com.codegym.management.model.Contract) target;
