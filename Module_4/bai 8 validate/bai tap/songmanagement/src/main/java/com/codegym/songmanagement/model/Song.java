...
public class Song {
    ...
    private int id;
    @NotBlank(message = "Ten bai hat khong chưa cac ki tu dat biet, toi da 800 ky tu")
    @Pattern(regexp = "^[a-zA-Z0-9]{1,800}$",message = "Ten bai hat khong chưa cac ki tu dat biet, toi da 800 ky tu")
