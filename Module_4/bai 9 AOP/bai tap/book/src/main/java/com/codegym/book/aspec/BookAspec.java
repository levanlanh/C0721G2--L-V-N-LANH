package com.codegym.book.aspec;
...
public class BookAspec {
    ...
    @AfterThrowing("execution(* com.codegym.book.controller.BookController.*(..))")
    public void logAfterMethodReturn(JoinPoint joinPoint){
        String nameMethod  = joinPoint.getSignature().getName();
        logger.error("tên phương thức " + nameMethod);
    }

    @After("execution( * com.codegym.book.controller.BookController.*(..))")
